...
# ✅ Supabase Credentials (Move key to environment variables in production)
    ...
    try:
        ...
        if response.data:
            ...
            for doctor in response.data:
                ...
                # ✅ Only include doctors within 50 km
                if distance_km <= 50:
                    doctor_data = {
                        "name": doctor["name"],
                        ...
                        "image_url": doctor.get("image_url", "https://via.placeholder.com/200")
                    }
